...
{
	void *child; /**< \private the object of a subclass 子类对象指针*/
	void *local; /**< \private instance object */ /*property_list类型*/

	/** the destructor virtual function */
	mlt_destructor close; /*mlt_service子类析构时，被调用*/
...
extern int mlt_properties_inc_ref( mlt_properties self );//有锁
extern int mlt_properties_dec_ref( mlt_properties self );//有锁
/**
 * 无锁
 */
