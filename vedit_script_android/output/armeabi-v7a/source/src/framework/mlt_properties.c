 ...
 *
 * ���name���ļ�������ļ���ʼ��
 * ����ǣ����PRESET_PATH/{type}/{service}/[{profile}/]{name}.��ʼ��properties��
 * ����profile����Ϊ�ա�
 * type,service,provile������������Ӧ��mtl_type,mlt_service/MLT_PROFILE����
 *
 * \public \memberof mlt_properties_s
 * \param self a properties list
 ...
 * ���that�������п����л�����prefixǰ׺������ֵ������ʱ������Ϊȥ��prefix�Ĳ���
 *
 ...
 *
 * propertiesֻ��Ҫ����hash�ṹ���?���ص�mlt_property�����Դ���
 */
