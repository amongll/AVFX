...
import tv.danmaku.ijk.media.sample.activities.TestJniActivity;
import tv.danmaku.ijk.media.sample.activities.TestMltActivity;
...
public class AppActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if ( id == R.id.action_testjni) {
            TestJniActivity.intentTo(this);
        } else if ( id == R.id.action_testmlt ) {
            TestMltActivity.intentTo(this);
        }
